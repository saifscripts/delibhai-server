...
const createVillages = (villages) => __awaiter(void 0, void 0, void 0, function* () {
    const existingVillages = yield village_model_1.Village.find({
    ...
    const newVillages = yield village_model_1.Village.create(villages);
...
const updateVillage = (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
    const village = yield village_model_1.Village.findById(id);
    if (!village) {
    ...
    const isVillageExists = yield village_model_1.Village.findOne({
        unionId: village.unionId,
        title: payload.title,
    });
    if (isVillageExists) {
    ...
    const updatedVillage = yield village_model_1.Village.findByIdAndUpdate(id, payload, {
        new: true,
    });
    if (!updatedVillage) {
...
const deleteVillage = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const deletedVillage = yield village_model_1.Village.findByIdAndUpdate(id, { isDeleted: true }, {
        new: true,
    });
    if (!deletedVillage) {
        throw new AppError_1.default(http_status_1.default.NOT_FOUND, 'Village not found!');
...
const getVillages = (unionId, query) => __awaiter(void 0, void 0, void 0, function* () {
    const villageQuery = new QueryBuilder_1.default(village_model_1.Village.find({ unionId }), query)
        .filter()
        .fields();
